...
# In dev/test, set SKIP_STATIC_SYNC=true to preserve files in static (no delete + copy from build).
# Docker/production leave unset so static is synced from frontend build.
SKIP_STATIC_SYNC = os.getenv("SKIP_STATIC_SYNC", "").lower() == "true"

if not SKIP_STATIC_SYNC:
    try:
